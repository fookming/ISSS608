...
format: 
  html:
    ...
    number-offset: [13, 0]  # Offset heading levels by starting at 14
output: 
  html_document: 
    toc: true
    tabset: true
...
[**heatmaply**](http://talgalili.github.io/heatmaply/index.html)
is an R package for building interactive cluster heatmap that can be
shared online as a stand-alone HTML file. It is designed and maintained
by Tal Galili.
