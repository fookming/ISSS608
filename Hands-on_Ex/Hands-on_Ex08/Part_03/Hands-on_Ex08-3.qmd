...
p1 <- tm_shape(NGA_wp) + 
  ...
  tm_borders(lwd = 0.1, 
             fill_alpha = 1) +  # Changed from 'alpha' to 'fill_alpha'
  tm_title("Distribution of functional water point by LGAs") +  # Replaced tm_layout(main.title = ) with tm_title()
  tm_layout(legend.outside = FALSE)  # Keep other layout settings
...
p2 <- tm_shape(NGA_wp) + 
  ...
  tm_borders(lwd = 0.1, 
             fill_alpha = 1) +  # Changed from 'alpha' to 'fill_alpha'
  tm_title("Distribution of total water point by LGAs") +  # Replaced tm_layout(main.title = ) with tm_title()
  tm_layout(legend.outside = FALSE)  # Keep other layout settings
