...
format: 
  html:
    ...
    number-offset: [20, 0]  # Offset heading levels by starting at 21
output: 
  html_document: 
    toc: true
    tabset: true
...
Among the four packages, **readr**, **tidyr** and **dplyr** are part of **tidyverse** package. The code chunk below will be used to install and load these packages in RStudio.
...
![Things to learn from the code chunk above:](images/clipboard-1348769026.png)
...
![](images/clipboard-3365984688.png)
...
![](images/clipboard-2966524033.png)
...
![Things to learn from *tm_polygons()*:](images/clipboard-1348769026.png)
...
![Notice that the planning subzones are shared according to the respective dependecy values](images/clipboard-1505035414.png)
...
![Notice that light-gray border lines have been added on the choropleth map.](images/clipboard-1196836240.png)
...
![](images/clipboard-1509775103.png)
...
![Notice that the distribution of quantile data classification method are more evenly distributed then equal data classification method.](images/clipboard-4154957186.png)
...
![](images/clipboard-2523321787.png)
...
![](images/clipboard-1649603698.png)
...
![](images/clipboard-3252397171.png)
...
![To reset the default style, refer to the code chunk below.](images/clipboard-2627447594.png)
...
![In this example, small multiple choropleth maps are created by assigning multiple values to at least one of the aesthetic arguments](images/clipboard-938468208.png)
...
![](images/clipboard-3832086748.png)
...
![](images/clipboard-548484865.png)
