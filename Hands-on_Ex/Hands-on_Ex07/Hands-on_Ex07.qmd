...
format: 
  html:
    ...
    number-offset: [16, 0]  # Offset heading levels by starting at 17
output: 
  html_document: 
    toc: true
    tabset: true
...
![](images/clipboard-264758679.png)
...
![](images/clipboard-1514388677.png)

Then we can simply group the count by hour and wkday and plot it, since we
know that we have values for every combination there’s no need to
...
![](images/clipboard-3474040838.png)
...
![](images/clipboard-1183549509.png)
...
programmatically by using ggplot2 functions.

![](images/clipboard-3155384785.png)
