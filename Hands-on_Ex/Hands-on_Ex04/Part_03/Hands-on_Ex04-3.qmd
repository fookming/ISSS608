...
format: 
  html:
    ...
    number-offset: [10, 0]  # Offset heading levels by starting at 11
output: 
  html_document: 
    toc: true
    tabset: true
...
-   [labs()]{.purple-text} argument of ggplot2 is used to change the x-axis label.
:::
...
![](https://r4va.netlify.app/chap10/img/ggdist.png){.framed-image}
